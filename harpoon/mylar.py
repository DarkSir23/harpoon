    ...
    def post_process(self):
        ...
        try:
            ...
            try:
                ...
                logger.debug('Got mylar_release_name')
            except:
                logger.debug('Failed to get mylar_release_name')
                try:
            ...
            logger.debug('IssueID: %s' % self.issueid)
            if self.issueid is None:
                if 'mylar_issuearcid' in data.keys() and data['mylar_issuearcid'] != 'None':
                    ...
                    if data['mylar_release_pack'] == 'False':
                        ...
                        issueid = None
                logger.debug('New IssueID: %s' % issueid)
